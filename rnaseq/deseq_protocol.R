...
workDir <- "/mnt/cube/scratch/brachyury/Mmu/GSE93524/deseq/"      # working directory for the R session

projectName <- "GSE93524"                         # name of the project
author <- "Rohit"                                # author of the statistical analysis/report

targetFile <- "seq.info"                           # path to the design/target file
